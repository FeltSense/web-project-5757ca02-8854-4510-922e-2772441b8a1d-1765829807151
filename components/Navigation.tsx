...
export default function Navigation() {
  ...
  <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
    ...
    <div className="flex items-center gap-3">
      ...
      {/* Mobile Menu Button */}
      <button className="md:hidden p-2 rounded-lg hover:bg-blue-500/20 transition-colors duration-200 text-slate-200">
  ...
  <div className="absolute bottom-0 left-0 h-1 bg-gradient-to-r from-transparent via-blue-400 to-transparent opacity-50" />
</nav>
